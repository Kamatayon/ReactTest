      ...
      <div className="container page-footer__container">
        <div className="page-footer__head">
          <div className="page-footer__contact-col">
            <div className="page-footer__header page-footer__header--contact">
              Contact us
            </div>
            <a href="tel:+971582322400" className="page-footer__phone">
              <img
                src="assets/svg_icons/phone.svg"
                alt=""
                className="page-footer__phone-icon"
              />
              <span className="page-footer__phone-text">1 800 289 4743</span>
            </a>
            <a href="mailto:info@trivialbuy.com" className="page-footer__email">
              info@gotuguzel.com
            </a>
          </div>
            ...
            <ul className="page-footer__category">
              <li className="page-footer__category-li page-footer__category-li--how-to">
                ...
                <ul className="page-footer__links">
                  <li className="page-footer__links-li">
          ...
          <div className="page-footer__social-col page-footer__social-col--mobile">
              ...
              <ul className="social__list">
                <li className="social__li">
                  <a href="#" className="social__item">
                    <img
                      src="assets/svg_icons/facebook.svg"
                      alt=""
                ...
                <li className="social__li">
                  <a href="#" className="social__item">
                    <img
                      src="assets/svg_icons/twitter.svg"
                      alt=""
                      className="social__img"
                    />
                  </a>
                ...
                <li className="social__li">
                  <a href="#" className="social__item">
                    <img
                      src="assets/svg_icons/youtube.svg"
                      alt=""
                      className="social__img"
                    />
                  </a>
            ...
            <a href="#" className="page-footer__by page-footer__by--mobile">
              <img
                src="assets/svg_icons/nkh.svg"
                alt=""
                className="page-footer__by-img"
              />
            </a>
          </div>
        </div>
        <div className="page-footer__bot">
          <div className="page-footer__copy">
            ...
            <div className="page-footer__copy-desc">
              These are related items according to shopper's purchase history.
            </div>
          </div>
          ...
          <a href="#" className="page-footer__by">
            <img
              src="assets/svg_icons/nkh.svg"
              alt=""
              className="page-footer__by-img"
