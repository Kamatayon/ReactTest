...
import logoMobile from "assets/svg_icons/logo-mobile.svg";
import ring from "assets/svg_icons/ring.svg";
    ...
    <header className="page-header">
      <div className="container page-header__container js-parent-container">
        ...
        <button type="button" className="page-header__profile">
          <img src={user} alt="" className="page-header__profile-icon" />
          <div className="page-header__profile-text">
            Hello, Sign in{" "}
            <span className="page-header__profile-red">Cratsman India</span>
          </div>
            ...
            <div className="page-header__profile-wrapper">
              <ul className="page-header__profile-list">
                <li className="page-header__profile-li">
                  <a href="#" className="page-header__profile-link">
                    Profile Edit
                  </a>
                </li>
                <li className="page-header__profile-li">
